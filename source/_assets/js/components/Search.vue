    ...
    <div class="flex flex-1 justify-end items-center text-right px-4">
        ...
        >
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full lg:w-1/4 lg:focus:w-full bg-gray-100 border border-gray-500 focus:border-blue-400 outline-none cursor-pointer text-gray-700 px-4 pb-0 pt-px"
